...
//function calculating and returning translation of matrix
MyMatrix3 MyMatrix3::translate(int dx, int dy)
{
	MyMatrix3 answer = MyMatrix3();
	answer.m_a11 = 1;
	answer.m_a12 = 0;
...
//function returning scaling matrix
MyMatrix3 MyMatrix3::scale(int dx, int dy)
{
	MyMatrix3 answer = MyMatrix3();
...
MyMatrix3 MyMatrix3::rotationX(double angle)
{
	double radians = 3.14 / 180 * angle;
	MyMatrix3 answer = MyMatrix3();
	answer.m_a11 = 1;
...
MyMatrix3 MyMatrix3::rotationY(double angle)
{
	double radians = 3.14 / 180 * angle;
	MyMatrix3 answer = MyMatrix3();
	answer.m_a11 = std::cos(radians);
...
MyMatrix3 MyMatrix3::rotationZ(double angle)
{
	double radians = 3.14 / 180 * angle;
	MyMatrix3 answer = MyMatrix3();
...
//scale matrix in 3d space
MyMatrix3 MyMatrix3::scale3D(int dx)
{
	MyMatrix3 answer = MyMatrix3();
	answer.m_a11 = (double)dx / 100;
	answer.m_a12 = 0;

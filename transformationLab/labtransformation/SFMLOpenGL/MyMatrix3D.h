...
public:
	...
	MyMatrix3 translate(int dx, int dy);
	MyMatrix3 scale(int dx, int dy);
	MyMatrix3 operator-();

	MyMatrix3 rotationX(double angle);
	MyMatrix3 rotationY(double angle);
	MyMatrix3 rotationZ(double angle);

	MyMatrix3 scale3D(int dx);
